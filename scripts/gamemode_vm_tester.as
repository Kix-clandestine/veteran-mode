...
class GameModeVMTester : Metagame {
    GameModeVMTester(const XmlElement@ settings) {
    ...
    void postBeginMatch() {
        ...
        XmlElement element(dictionary = {{"TagName", "command"},{"class", "chat"},{"text", "WELCOME TO VETERAN MODE QM TESTING! :)"}});
